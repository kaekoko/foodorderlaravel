...
class ItemController extends Controller
{
    ...
    public function additem() {
        ...
        return view('additem', compact('getcategory','getitem','getingredients','getaddons'));
    }
    ...
    public function edititem($id) {
        ...
        return view('edititem', compact('item','getitem','getcategory','getingredients','getaddons','getvariation','getitemimages'));
    }
